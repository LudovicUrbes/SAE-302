    ...
    <?php if (isset($_SESSION['user'])) : ?>
        <section class="w-full h-full bg-white">
            <header class="w-full h-fit bg-gray-200 inline-flex items-center justify-between flex-nowrap">
                <h1 class="text-2xl ml-4">Page d'Administration</h1>
                <h1 class="text-2xl ml- 4 "> <a href ="/SAE-302/concours/index.php">Concours</a></h1>
                    ...
                    ?>
                            ...
                            <div class="col-span-1 max-w-sm rounded overflow-hidden shadow-lg relative">
                                ...
                                <div class="absolute bottom-1 right-2 p-1">
                                    ...
                                    <input id="default-checkbox" type="radio" value="vote" name="vote" class="w-4 h-4 overflow-hidden rounded text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700">
                                    <div id="fb-root"></div>
